	...
	public static void main(String[] args) {
		...
		while(playing) {
			...
			try {
				...
				Game game;
				if (choice == 1) {
					game = new Hangman(); // You CAN change this line, if you're not doing Spaceship
				}else if (choice == 2) {
					game = new BattleShip(); // You CAN change this line, if you're not doing ChoHan
				}else {
